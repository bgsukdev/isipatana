...
export default function GymnasticsPage() {
  const coreDisciplines = [
    { title: "Floor Exercises", description: "Developing grace, flexibility, and powerful tumbling pass sequences." },
    { title: "Vault & Bars", description: "Emphasis on core strength, explosive power, and aerial precision." },
    { title: "Balance Beam", description: "Mastering focus and unwavering stability through structured drills." }
  ];
    ...
    <div className="bg-white">
      ...
      <section className="relative py-32 md:py-48 overflow-hidden">
        ...
        <div className="relative container-custom text-white">
          <div className="max-w-4xl">
            <span className="inline-block px-4 py-1 bg-[var(--accent-gold)] text-[var(--primary-blue)] text-xs font-black rounded-full mb-6 uppercase tracking-[0.2em]">Grace & Power</span>
            <h1 className="text-6xl md:text-9xl font-black mb-6 tracking-tighter uppercase italic leading-none">
              GYMNASTICS <br/>ARTISTRY
            </h1>
            <p className="text-xl md:text-2xl text-gray-200 leading-relaxed italic border-l-4 border-[var(--accent-gold)] pl-6 max-w-2xl">
              "Redefining the limits of movement. A discipline of focus, strength, and clinical precision."
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="relative mt-20 z-10 pb-20">
        <div className="container-custom">
           <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8">
              {[
                { label: 'Core Strength', value: '100%' },
                { label: 'Flexibility', value: 'Elite' },
                { label: 'Training Sessions', value: 'Weekly' },
                { label: 'National Rank', value: 'Top 5' }
              ].map((stat, idx) => (
              ...
              <div className="relative order-2 lg:order-1">
                 <div className="aspect-[4/5] relative rounded-[4rem] overflow-hidden shadow-2xl">
                    ...
                    <div className="absolute bottom-10 left-10 p-10 bg-white/10 backdrop-blur-2xl rounded-[3rem] border border-white/20 text-white max-w-xs">
                       <p className="text-2xl font-black italic mb-2 tracking-tighter">Precision Form</p>
                       <p className="text-sm font-bold uppercase tracking-widest text-[var(--accent-gold)]">Nurturing Youth Talent</p>
                    </div>
                 </div>
              </div>
              
              <div className="order-1 lg:order-2">
                 <h2 className="text-4xl md:text-6xl font-black text-[var(--primary-blue)] mb-8 uppercase tracking-tighter italic leading-tight">Strength in Motion</h2>
                 <p className="text-xl text-gray-500 font-bold leading-relaxed mb-12">
                   Gymnastics at Isipathana is more than just agility; it is a fundamental pillar of athletic development. Our students master complex maneuvers under elite supervision, building the foundation for all-round physical excellence.
                 </p>
                 <div className="space-y-12 mb-12">
                    {coreDisciplines.map((item, idx) => (
                      <div key={idx} className="p-8 bg-[var(--gray-50)] rounded-3xl border-l-4 border-[var(--primary-blue)] hover:bg-white hover:shadow-xl transition-all">
      ...
      <section className="py-32 bg-[var(--primary-blue)] relative overflow-hidden">
        ...
        <div className="container-custom relative z-10 text-center">
           <h2 className="text-4xl md:text-6xl font-black text-white italic uppercase tracking-tighter mb-8">Clinical Discipline</h2>
           <p className="text-xl text-gray-300 font-medium max-w-3xl mx-auto leading-relaxed mb-12">
             Our gymnasts are trained from junior school levels to achieve national eligibility, focusing on international standards of flight, balance, and landing precision.
           </p>
      ...
      <section className="section-padding bg-[var(--gray-50)]">
         <div className="container-custom">
            <div className="max-w-4xl mx-auto bg-white rounded-[4rem] p-12 md:p-24 text-center border border-[var(--gray-200)] shadow-sm">
               ...
               <h3 className="text-3xl md:text-5xl font-black text-[var(--primary-blue)] mb-6 tracking-tighter uppercase italic">Gymnastics Committee</h3>
               <p className="text-xl text-gray-500 font-bold max-w-2xl mx-auto mb-12">
                 We are expanding our training facilities with new apparatus and safety equipment. To support the gymnastics program or enroll your ward, please contact our secretariat.
               </p>
